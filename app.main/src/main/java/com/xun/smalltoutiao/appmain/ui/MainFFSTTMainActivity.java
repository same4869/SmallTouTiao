...
public class MainFFSTTMainActivity extends AppCompatActivity
    ...
    private static String[] sUris = new String[]{"news/newsMain", "pic/picMain", "videoTabFragment", "mediaChannelTabFragment"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_activity_ffsttmain);
...
//                    ft.add(R.id.main_container, newsTabLayout, NewsTabLayout.class.getName());
//                } else {
...
//                }
        ...
        curFragment = Small.createObject("fragment-v4", sUris[position], MainFFSTTMainActivity.this);
        if (curFragment == null) {
            curFragment = MainPlaceholderFragment.newInstance(sUris[position]);
        }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            intent.putExtra("small", MainSmallService.SMALL_UPDATE_BUNDLES);
            startService(intent);
            super.onBackPressed();
        }
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_share) {
            ...
            Intent intent1 = new Intent(this, MainSmallService.class);
            intent1.putExtra("small", MainSmallService.SMALL_CHECK_UPDATE);
            startService(intent1);
        } else if (id == R.id.test_plugin_add) {
            Intent intent1 = new Intent(this, MainSmallService.class);
            intent1.putExtra("small", MainSmallService.SMALL_CHECK_ADD);
            startService(intent1);
        }
